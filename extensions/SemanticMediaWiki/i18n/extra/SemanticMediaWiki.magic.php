...
$magicWords['ar'] = [
	...
	'smwdoc' => [ 0, 'وثائق_سمو', 'وثائق_ميدياويكي_الدلالية' ],
	'set' => [ 0, 'تعيين' ],
	'set_recurring_event' => [ 0, 'تعيين_حدث_دوري' ],
	'declare' => [ 0, 'إعلان', 'إشهار' ],
	'SMW_NOFACTBOX' => [ 0, '__بلا_صندوق_حقائق__' ],
	'SMW_SHOWFACTBOX' => [ 0, '__عرض_صندوق_الحقائق__' ]
];
